...
<center><div class="login">	
    <div class="registrd form-group" >
        <h3 style="color: #1abc9c">Tạo Tài Khoản</h3>
        <p class="error" style="color: red"><?php echo $notify ?></p>
        <form action="" method="post" id="register">
          ...
          <ul class="forms">
            <li class="txt">&nbsp;</li>
            <li><a href="javascript:document.getElementById('sm').click()" class="simplebtn btn-lg" style="background-color: #1abc9c; color: white; text-decoration: none;"><span>Đăng Ký</span></a> <input  type="submit" name="submit" style="width:0;height:0;border:none;display: none;" value="Register" id="sm">
            </li>
        </ul>
        </form>
    </div>

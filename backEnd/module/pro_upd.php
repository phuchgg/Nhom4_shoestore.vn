<?php
	...
	//lAY THONG TIN SAN PHAM
	  $sql="SELECT * FROM `nn_product` WHERE `id_pro`=$id";
	  $rs=mysqli_query($conn,$sql);
	  $rinfo=mysqli_fetch_assoc($rs);
	if(isset($_POST['name']))
	{
	    $cid=$_POST['cid'];
	    $did=$_POST['did']; 
  ...
  <table class="create_content" width="800" border="0">
	...
	?>
      ...
      <td height="200" rowspan="9" width="300">
		  <label>
			<img id="preimg"  src="public/img/<?php if(is_file('public/img/'.$rinfo['img_url'])) echo $rinfo['img_url'];else echo 'add_image.png';?>" alt="your image" height="200" /><br>
    ...
    <tr>
      <td width="407">
        ...
        {
          ?>
             <option <?php if($r['id_cat']==$rinfo['category_id']) echo 'selected' ?> value="<?php echo $r['id_cat']?>"><?php echo $r['name_cat']?></option>
          <?php
          }
          ?>
        </select>
    ...
    <tr>
      <td width="407"><input type="text" name="name" id="name" value="<?php echo $rinfo['name_pro']?>" /></td>
    </tr>
    <tr>
      <th scope="row">Giá</th>
    </tr>
    <tr>
      <td><input type="text" name="price" id="price" value="<?php echo $rinfo['price']?>" /></td>
    </tr>
    <tr>
      <th scope="row">Số lượng</th>
    </tr>
    <tr>
      <td><input type="number" min="1" name="qty" id="qty" value="<?php echo $rinfo['qty']?>" /></td>
    </tr>
    <tr>
      <th scope="row">Hiện Thị</th>
      <td height="80" rowspan="3" width="300" class="small_Image">
        <label>
          <img id="preimg1"  src="public/img/<?php if(is_file('public/img/'.$rinfo['img_url'])) echo $rinfo['img_url1'];else echo 'add_image.png';?>" alt="your image" width="80" /><br>
          <input  onchange="readURL1(this)" type="file" name="img_url1" id="img_url1" style="display:none" />
        </label>
        <label>
          <img id="preimg2"  src="public/img/<?php if(is_file('public/img/'.$rinfo['img_url'])) echo $rinfo['img_url'];else echo 'add_image.png';?>" alt="your image" width="80" /><br>
          <input  onchange="readURL2(this)" type="file" name="img_url2" id="img_url2" style="display:none" />
        </label>
        <label>
          <img id="preimg3"  src="public/img/<?php if(is_file('public/img/'.$rinfo['img_url'])) echo $rinfo['img_url'];else echo 'add_image.png';?>" alt="your image" width="80" /><br>
    ...
    <tr>
      ...
      <select name="active" id="active">
         <option <?php if($rinfo['active']==1) echo 'selected' ?> value="1">Hiện</option>
        <option <?php if($rinfo['active']==0) echo 'selected' ?> value="0">Ẩn</option>
      </select>
      </td>
    </tr>
    <tr>
      <th scope="row">Mô tả</th>
        ...
        <tr>
      <td colspan="2"><textarea name="desc" id="desc" style="width: 800px;height: 120px"><?php echo $rinfo['desc']?></textarea></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2"><textarea name="detail" id="detail"><?php echo $rinfo['detail']?></textarea></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2"><textarea name="note" id="note"><?php echo $rinfo['note']?></textarea></td>
      <td></td>
    </tr>
    <tr>
